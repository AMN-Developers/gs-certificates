...
type TCertificateTemplateImpersProps = {
  certificate: {
    date: Date;
    clientName: string;
    companyName: string;
...
export default function CertificateTemplateImpers({
  certificate,
  certificateNumber,
}: TCertificateTemplateImpersProps) {
      ...
      <div className="mb-8 space-y-6">
        <div className="flex w-full flex-col gap-4 sm:flex-row sm:justify-end">
          <Button
            ...
            size="sm"
            className="inline-flex items-center justify-center gap-2 rounded-md bg-brand px-4 py-2 text-base font-medium text-white shadow-sm transition-colors hover:bg-brand/90 disabled:cursor-not-allowed disabled:opacity-50"
          >
            {isGenerating ? (
          ...
          >
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <h1 className="text-center text-xl font-bold md:text-2xl">
                Certificado de garantia da impermeabilização gerado com sucesso
              </h1>
